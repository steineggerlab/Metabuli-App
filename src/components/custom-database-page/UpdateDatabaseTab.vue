    ...
    <v-form ref="jobForm" v-model="isJobFormValid">
      <v-container>
        <v-card variant="outlined" color="primary">
          <v-card-title class="text-subtitle-2">
            Please refer to the
            <a href="https://github.com/steineggerlab/Metabuli" target="_blank"
              >Metabuli documentation</a
            >
            for more information on how to update a database.<br />
            You can add new sequences to an existing database. Adding new taxa
            is also possible with <code>--new-taxa</code> option.</v-card-title
          >
        </v-card>
      </v-container>
          ...
          <v-container class="py-2">
            ...
            <v-row>
              <v-col cols="3">
                ...
                <v-list-subheader class="pr-0"> </v-list-subheader>
              </v-col>
      ...
      <v-expand-transition>
        <div
          ...
          class="search-advanced-settings w-75 pt-0 pb-2"
        >
          <!-- Input fields -->
            ...
            <v-container class="px-0">
              <v-card variant="outlined" color="primary">
                <v-card-text class="text-caption">
                  NOTE: Mixing taxonomies within the same domain is not
                  recommended. For example, adding prokaryotes to a GTDB
                  database using NCBI taxonomy will cause issues, but adding
                  eukaryotes or viruses is fine since GTDB does not cover them.
                </v-card-text>
              </v-card>
            </v-container>
          </v-container>
