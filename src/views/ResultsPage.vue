		...
		<v-card-text class="d-flex flex-column h-100 pb-0">
			<v-tabs-window v-model="tab" class="h-100">
				...
				<SankeyNodeDialog v-if="dialogData" v-model="isDialogVisible" :nodeDetails="dialogData"
					:configureMenuSettings="sankeyConfigurationSettings" @close-dialog="hideDialog" class="align-top" />
				...
				<v-tabs-window-item value="sankey" class="h-100">
					...
					<div class="d-flex justify-space-around my-5 mx-2 gc-1">
						...
						<SankeyDownloadMenu :menuLocation="'bottom center'" @format-selected="downloadFullSankey">
						...
						<ConfigureSankeyMenu :maxTaxaLimit="roundedMaxTaxaLimit" :menuLocation="'bottom end'"
							v-model:color-scheme="colorScheme" v-model:show-all="showAll"
							v-model:min-clade-reads-mode="minCladeReadsMode" v-model:min-clade-reads="minCladeReads"
					...
					<!-- SANKEY DIAGRAM -->
					<TaxoView v-if="originalData" :rawData="originalData" :colorScheme="colorScheme" :taxaLimit="taxaLimit"
						:minThresholdMode="minCladeReadsMode" :minThreshold="minCladeReads" :figureHeight="figureHeight"
